...
import org.sosapp.gcmclient.util.SystemUiHider;
...
public class SOSActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView sosTextView = (TextView) findViewById(R.id.fullscreen_content);
        sosTextView.setText(getIntent().getExtras().get("gcmMessage").toString());
